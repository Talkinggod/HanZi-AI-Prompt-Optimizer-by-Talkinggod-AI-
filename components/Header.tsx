...
import { IconHistory } from './IconComponents';

interface HeaderProps {
  onToggleHistory: () => void;
}

// Replaced the SVG placeholder with a direct URL to the GitHub-hosted logo.
    ...
    <header className="bg-brand-dark p-4 shadow-md border-b border-brand-darker">
      <div className="container mx-auto flex justify-between items-center">
        <div className="flex items-center space-x-3">
            ...
            <span className="text-sm font-light text-white">by Talkinggod AI</span>
        </div>
